...
deployment:
  tasks:
    - export DEPLOYPATH=/home2/matchpo3/public_html/hr
...
> **Note:** `matchpo3` = WordPress Plus cPanel username. Raf to confirm exact username and update
...
- [ ] [Phase 5] MySQL Databases wizard → create database (e.g. `matchpo3_ihrp`) + user
  (e.g. `matchpo3_ihrp`) + strong password → grant all privileges
- [ ] [Phase 5] Subdomains → create `hr.matchpointegroup.com` → set Document Root to
  `/home2/matchpo3/public_html/hr/public` (the Laravel public/ dir)
...
- [ ] [Phase 5] cPanel → Git Version Control → Create Repository
  - Repository Path: `/home2/matchpo3/repos/ihrp.git` (bare repo on server)
  - OR: clone from GitHub if Bluehost allows external clone
- [ ] [Phase 5] Locally: add Bluehost SSH remote
  ```bash
  git remote add bluehost ssh://matchpo3@matchpointegroup.com/home2/matchpo3/repos/ihrp.git
  ```
- [ ] [Phase 5] Test SSH connection: `ssh matchpo3@matchpointegroup.com`
- [ ] [Phase 5] Confirm cPanel Git deploy path is set to `/home2/matchpo3/public_html/hr`
...
- [ ] [Phase 5] SSH into server → verify files landed:
  `ls /home2/matchpo3/public_html/hr/`
- [ ] [Phase 5] SSH: copy .env.production.example → .env and fill in all values:
  ```bash
  cp /home2/matchpo3/public_html/hr/.env.production.example \
     /home2/matchpo3/public_html/hr/.env
  nano /home2/matchpo3/public_html/hr/.env
  ```
- [ ] [Phase 5] Generate fresh APP_KEY if needed:
  `php /home2/matchpo3/public_html/hr/artisan key:generate`
...
- [ ] [Phase 5] cPanel phpMyAdmin → select `matchpo3_ihrp` → Import → choose file
...
- [ ] [Phase 5] Verify caches already ran via `.cpanel.yml`:
  `ls /home2/matchpo3/public_html/hr/bootstrap/cache/`
